...
void				for_h(char format, va_list ap, a_struct flags,\
int *len_res);
void				for_l(char format, va_list ap, a_struct flags,\
int *len_res);
void				for_ll(char format, va_list ap, a_struct flags,\
int *len_res);
void				for_hh(char format, va_list ap, a_struct flags,\
int *len_res);
